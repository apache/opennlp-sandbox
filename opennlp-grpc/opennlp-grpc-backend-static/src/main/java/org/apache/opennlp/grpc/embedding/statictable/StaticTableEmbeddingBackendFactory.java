 ...
 * embedding tables served through the {@code opennlp-embeddings} extension module,
 * pure JVM with no native runtime.
 */
public final class StaticTableEmbeddingBackendFactory implements EmbeddingBackendFactory {

  /** Public no-arg constructor required by {@link java.util.ServiceLoader}. */
  public StaticTableEmbeddingBackendFactory() {
  }
