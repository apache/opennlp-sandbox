...
| 2d    | Graduate modules to `apache/opennlp` (after community review); optional core `Document` interface alignment if not already available in 3.0.0-M4                                                                                         |
