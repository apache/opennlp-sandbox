...
public class ReviewBuilderRunner {
	...
	public ReviewBuilderRunner(){
		...
		input.add(new Triple<>("clarks trolley womens shoes", 1581854074, "clark womens shoes"));
		input.add(new Triple<>("mens evans shoes imperial deer", 210808400, "lb evans slippers"));
		input.add(new Triple<>("ugg classic bow shorty gloves", 1665094898, "leather gloves women"));
		input.add(new Triple<>("jumping beans man tee baby", 1667155332, "jumping beans clothing"));
		input.add(new Triple<>("asics mens shoes", 1630208773, "asics mens running shoes"));
		input.add(new Triple<>("oakley hoodie mens fleece", 1656661466, "hoodies for men"));
		input.add(new Triple<>("usb sound control digital voice recorder", 1654662662, "digital voice recorder with usb"));
		input.add(new Triple<>("motorola bluetooth headset", 215376254, "motorola oasis bluetooth headset"));
		input.add(new Triple<>("sony sound bar home theater system", 215450833, "sony sound bar"));
		input.add(new Triple<>("jvc full hd everio camcorder", 1664479999, "jvc everio camcorder"));
	 */
		
	 input.add(new Triple<>("dr martens beckett laceup boots", 1651452641, "doc martin shoes"));
	 input.add(new Triple<>("pioneer cd changer",204654672, "pioneer cd player"));
	 input.add(new Triple<>("tablet handler strap and desk mount", 1634326303, "tablet holder"));
	 input.add(new Triple<>("sockwell loden womens overthecalf socks", 1644572708, "compression stockings, support stockings"));
	 input.add(new Triple<>("nike eclipse womens shoes", 1657807048, "nike eclipse ii women s shoe"));
	 input.add(new Triple<>("cherokee workwear womens scrub pant black stall",211643295, "cherokee workwear scrubs"));
	 input.add(new Triple<>("columbia sportswear jacket ", 1667381935, "columbia omni heat"));
	 input.add(new Triple<>("adidas adipure jacket", 1040124787, "adidas track jacket"));
	 input.add(new Triple<>("clarks may orchid womens shoes", 1585805688, "clarks loafers"));
	 input.add(new Triple<>("levis pants empire blue", 1670283141, "skinny jeans for guys"));
...
/*
	 ...
	 input.add(new Triple<>("able planet headphones", 1648522886, "able planet nc210g"));
	 input.add(new Triple<>("samsung replacement lamp", 695793593, "lamp code bp96"));
	 input.add(new Triple<>("paul green emerson boot castagno", 1313967918, "paul green emerson boot"));
	 input.add(new Triple<>("bandolino caresse boots", 1448643623, "bandolino caresse boots"));
	 input.add(new Triple<>("nine west modiley", 1365998968, "nine west modiley"));
	 input.add(new Triple<>("converse chuck taylor  bisay", 1555900934, "turquoise chuck taylors"));
	 input.add(new Triple<>("gentle souls bay leaf flats", 1436175162, "gentle souls bay leaf"));
	 input.add(new Triple<>("sauce hockey  back hat", 1644440355, "sauce hockey discount code"));
	 input.add(new Triple<>("aravon farren oxford shoes", 1644573438, "aravon wef07sh"));
*/	 input.add(new Triple<>("kooba crosby hobo handbags", 1326503038, "kooba crosby"));
	 input.add(new Triple<>("bcbgmaxazria sheath dress", 1313949777, "bcbgmaxazria illusion bodice ruched sheath dress"));
	 input.add(new Triple<>("billabong boardshorts trunks", 1316823074, "la siesta boardshorts"));
	 input.add(new Triple<>("mootsies tootsies boot", 1503727310, "mootsies tootsies draker"));
	 input.add(new Triple<>("nine west bootie", 1503730060, "nine west drina"));
	 input.add(new Triple<>("playtex support cotton ", 1331026244, "playtex t723"));
	 input.add(new Triple<>("fossil morgan satchel taupe", 1355165745, "fossil morgan satchel"));
	 input.add(new Triple<>("katonah womens boots brown", 1420057844, "boc katonah boots"));
	 input.add(new Triple<>("boot cut jeans supernova", 1363356262, "levis 527 supernova"));
	 input.add(new Triple<>("steve madden buckie boot", 1313965918, "steve madden buckie boot"));
	 input.add(new Triple<>("charlies horse tshirt", 1428490587, "charlie s horse shirt"));
	 input.add(new Triple<>("igloo little playmate ice chest", 205421625, "igloo little playmate"));
	 input.add(new Triple<>("mark nason boot", 1313951044, "mark nason rudd"));
